...
add_type("cfloat", "complex float", "cfloat_t", 8)
add_type("cdouble", "complex double", "cdouble_t", 16)
...
impl.write(impl_tmpl.render(TYPEMAP=TYPEMAP, VECTORMAP=VECTORMAP, ntypes=ntypes, cuda_decl=cuda_decl))
impl.close()
