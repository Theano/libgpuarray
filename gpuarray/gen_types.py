...
#ifndef LIBGPUARRAY_GPUARRAY_TYPES_H
#define LIBGPUARRAY_GPUARRAY_TYPES_H
/** \\file types.h
...
#endif  // LIBGPUARRAY_GPUARRAY_TYPES_H
""")
...
with open("include/gpuarray/types.h", "w") as f:
    f.write(header)

with open("src/gpuarray/types.c", "w") as f:
    f.write(impl)
